  ...
  return (
    <Reveal>
      <section className="mb-10 rounded-2xl border border-white/10 bg-gradient-to-br from-brand via-brand to-brand-dark p-5 text-white shadow-xl shadow-black/30 sm:p-6">
        <h2 className="text-xl font-bold text-gold-light">{t("artistSearch.heading")}</h2>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          />
          <button onClick={go} className="rounded-lg bg-gradient-to-r from-gold-light to-gold px-4 py-2 text-sm font-bold text-brand-dark transition hover:scale-105">
